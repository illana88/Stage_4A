...
if arg1==3 or arg1==5 :
    ...
    if "samples" in globals() and len(samples)!=0 :
        ...
        print("I did not get any BAM files from all_bams.tsv (from column 2), Please make sure that col3 contains string {protein} for KD samples, ESITING")
        
        with open("Summary_stats", "a") as f :
            f.write("I did not get any BAM files from all_bams.tsv (from column 2), Please make sure that col3 contains string {protein} for KD samples, ESITING")
...
if arg1==4 or arg1==5 :
    ...
    if cryptics_flg==1 :
        ...
        if events_bed_create_flg==1 :
            ...
            print("CALLING TxEnsDB103_layeredV6.R to generate bed files") ##### Teste jusqu'ici et tout fonctionne #####
            ...
            for sample in samples :
                ...
                if (upexon==dnexon and upexonl!=dnexonl) : # condition [ $upexonl -ne $dnexonl ] REMOVES EXON_SKIP events
                    ...
                    if (usd_abs<=5 or dsd_abs<=5) :
                        ...
                        with open("res_ce_all/Annotated_junctions.csv", "a", newline='') as f:
                            writer = csv.writer(f)
...
if arg1==4 or arg1==5 :
    ...
    with open("all_bams.tsv", 'r') as file:
        for line in file:
            ...
            if len(columns) > 2 and re.search(protein, columns[2]) :
                filename = columns[1]
